...
- **2026-09-12 — Interactive UI and inference optimizations.** We release an interactive world-exploration UI that generates **1.5-second video chunks in 1.34 seconds on average** on **five H200 GPUs**, at **640×384 resolution and 24 FPS**.
